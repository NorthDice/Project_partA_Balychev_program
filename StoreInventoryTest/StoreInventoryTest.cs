namespace StoreInventoryTest
{
    ...
    public class StoreInventoryTest
    {
            ...
            {
                new StoreItem(1000, 10, Items.None),
                new StoreItem(500, 3, Items.None),
                new StoreItem(3000, 5, Items.None),
                new StoreItem(1400, 20, Items.None)
            };
            ...
            public void Add_Valid()
            {
                // Arrange
                StoreInventory inventory = new StoreInventory();
                StoreItem newItem = new StoreItem(200, 2, Items.Mouse);
            ...
            {
                // Arrange
                StoreItem itemToRemove = new StoreItem(500, 3, Items.None);
                StoreInventory inventory = new StoreInventory()
            {
                new StoreItem(1000, 10, Items.None),
                new StoreItem(3000, 5, Items.None),
            ...
            {
                // Arrange
                StoreItem itemToCheck = new StoreItem(500, 3, Items.None);
                StoreInventory inventory = new StoreInventory()
            {
                new StoreItem(1000, 10, Items.None),
                new StoreItem(3000, 5, Items.None),
